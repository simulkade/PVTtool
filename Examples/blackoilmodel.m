...
V_oil_res = liquid_z_res*(1-vapor_frac_res)*R*T0/p0;
mixture1.mole_fraction=vapor_y;
[liquid_z, vapor_z_res, fugacity, HR] = PREOS(mixture1, thermo1);
V_gas_res = vapor_z_res*vapor_frac_res*R*T0/p0;

%[s1, sl, sv] = stabilityTest(mixture1, thermo1)
Bo = V_oil_res/V_oil_surface
Bg = V_gas_res/V_oil_surface
Rs = (vapor_frac_surf-vapor_frac_res)*vapor_z_surf*R*T0/p0/V_oil_surface
rs = (vapor_frac_res-vapor_frac_surf)*liquid_z_surf*R*T0/p0/V_gas_surface;
if rs<0
  rs=0;
end
rs